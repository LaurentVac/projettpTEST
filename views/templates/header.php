            ...
            <nav class="navbar navbar-expand-lg col-12 ">
                ...
                <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                    <div class="navbar-nav">  
                        <a class="nav-link active navheader ml-4" href="homepage.php">Accueil</a>
                        ...
                        <a class="nav-link navheader ml-4" href="login-signup.php">
                            <button type="submit" class="btn buttonNav mt-2 d-md-none ">Mon compte</button>
                        </a>
                    </div> 
                </div>
                <a href="/admin_page.php"><button type="submit" class="btn buttonNav mt-2 mr-1 d-none d-md-block">ADMIN</button></a>
                <a href="login-signup.php"><button type="submit" class="btn buttonNav mt-2 d-none d-md-block">Mon compte</button></a>
            </nav>  
        </div>
    </header>